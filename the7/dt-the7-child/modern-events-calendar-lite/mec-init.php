...
class MEC
{
    ...
    public function category()
    {
        ...
        echo '<div class="custom-category-page-breadcrumbs"><a href="'.home_url().'" rel="nofollow">Home</a>';
            echo "&nbsp;&nbsp;/&nbsp;";
            echo '<a href="https://s3.axcelworld.com/meetings-list/" rel="nofollow">Meetings</a>';
        echo '</div>';
