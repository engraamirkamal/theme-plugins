...
class Tshowcase_Search_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		?>
		"><?php echo __( 'Title', 'tshowcase' ); ?>:</label>
		...
		" /></p>
		 ...
		 <label for="
		 <?php
			echo $this->get_field_id( 'taxonomies' );
			?>
		"><?php echo __( 'Display', 'tshowcase' ); ?> <?php echo $groupslabel; ?> <?php echo __( 'Filter', 'tshowcase' ); ?>:
		</label>
		<select id="
		<?php
		echo $this->get_field_id( 'taxonomies' );
		...
		">
		  ...
		  <?php
			...
			?>
		><?php echo __( 'Yes', 'tshowcase' ); ?></option>
		  <option value="false" 
		  <?php
			selected( $groups, 'false' );
			?>
		><?php echo __( 'No', 'tshowcase' ); ?></option>
		</select></p>
		...
		<p>
		 <label for="
			<?php
			echo $this->get_field_id( 'taxonomies-2' );
			?>
		"><?php echo __( 'Display', 'tshowcase' ); ?> <?php echo __( $options['tshowcase_name_tax2'], 'tshowcase' ); ?> <?php echo __( 'Filter', 'tshowcase' ); ?>:
		</label>
		<select id="
			<?php
			echo $this->get_field_id( 'taxonomies-2' );
		...
		">
		  <option value="true" 
			<?php
			selected( $taxonomies, 'true' );
			?>
		><?php echo __( 'Yes', 'tshowcase' ); ?></option>
		  <option value="false" 
			<?php
			selected( $taxonomies, 'false' );
			?>
		><?php echo __( 'No', 'tshowcase' ); ?></option>
		</select></p>
		...
		<p>
		 <label for="
			<?php
			echo $this->get_field_id( 'taxonomies-3' );
			?>
		"><?php echo __( 'Display', 'tshowcase' ); ?> <?php echo __( $options['tshowcase_name_tax3'], 'tshowcase' ); ?> <?php echo __( 'Filter', 'tshowcase' ); ?>:
		</label>
		<select id="
			<?php
			echo $this->get_field_id( 'taxonomies-3' );
		...
		">
		  <option value="true" 
			<?php
			selected( $ctaxonomies, 'true' );
			?>
		><?php echo __( 'Yes', 'tshowcase' ); ?></option>
		  <option value="false" 
			<?php
			selected( $ctaxonomies, 'false' );
			?>
		><?php echo __( 'No', 'tshowcase' ); ?></option>
		</select></p>
		...
		<p>
		 <label for="
			<?php
			echo $this->get_field_id( 'taxonomies-4' );
			?>
		"><?php echo __( 'Display', 'tshowcase' ); ?> <?php echo __( $options['tshowcase_name_tax4'], 'tshowcase' ); ?> <?php echo __( 'Filter', 'tshowcase' ); ?>:
		</label>
		<select id="
			<?php
			echo $this->get_field_id( 'taxonomies-4' );
		...
		">
		  <option value="true" 
			<?php
			selected( $dtaxonomies, 'true' );
			?>
		><?php echo __( 'Yes', 'tshowcase' ); ?></option>
		  <option value="false" 
			<?php
			selected( $dtaxonomies, 'false' );
			?>
		><?php echo __( 'No', 'tshowcase' ); ?></option>
		</select></p>
		...
		<p><label for="
		<?php
		echo $this->get_field_id( 'custom_fields' );
		?>
		">Search <?php echo $ts_labels['titles']['info']; ?> Fields:</label>
		 <select id="
		 <?php
			echo $this->get_field_id( 'custom_fields' );
			?>
		...
		">
		  <option value="true" 
		  <?php
			selected( $custom_fields, 'true' );
			?>
		>Yes</option>
		  <option value="false" 
		  <?php
			selected( $custom_fields, 'false' );
			?>
		>No</option>
		</select>
		...
		?>
		"><?php echo __( 'Results URL', 'tshowcase' ); ?>:</label>
		<input class="widefat" id="
		<?php
		echo $this->get_field_id( 'url' );
		?>
