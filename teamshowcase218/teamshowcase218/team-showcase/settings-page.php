...
<table cellpadding="5" cellspacing="5" style="margin-bottom:50px;">
  ...
  <tr <?php echo $display; ?>>
	...
	<td colspan="2" nowrap><textarea style="width:100%; height:100px;" name="tshowcase-settings[tshowcase_custom_fields]">
	<?php
	if ( isset( $options['tshowcase_custom_fields'] ) ) {
		echo $options['tshowcase_custom_fields']; }
	?>
	</textarea>
  ...
  <tr <?php echo $display; ?>>
	...
	<td colspan="2"><textarea style="width:100%; height:100px;" name="tshowcase-settings[tshowcase_social_networks]">
	<?php
	if ( isset( $options['tshowcase_social_networks'] ) ) {
		echo $options['tshowcase_social_networks']; }
	?>
	</textarea>
  ...
  <tr>
	...
	<td nowrap>Width:
	  <input name="tshowcase-settings[tshowcase_tpimg_width]" type="text" value="
	  <?php
		if ( isset( $options['tshowcase_tpimg_width'] ) ) :
			echo $options['tshowcase_tpimg_width'];
endif;
		?>
		" size="3" />
	  Height:
	  <input name="tshowcase-settings[tshowcase_tpimg_height]" type="text" value="
	  <?php
		if ( isset( $options['tshowcase_tpimg_height'] ) ) :
			echo $options['tshowcase_tpimg_height'];
endif;
		?>
		" size="3" /></td>
  ...
  <tr>
	...
	<td nowrap><?php echo __( 'Width', 'tshowcase' ); ?>:
	  <input name="tshowcase-settings[tshowcase_timg_width]" type="text" value="
	  <?php
		if ( isset( $options['tshowcase_timg_width'] ) ) :
			echo $options['tshowcase_timg_width'];
endif;
		?>
		" size="3" />
	  <?php echo __( 'Height', 'tshowcase' ); ?>:
	  <input name="tshowcase-settings[tshowcase_timg_height]" type="text" value="
	  <?php
		if ( isset( $options['tshowcase_timg_height'] ) ) :
			echo $options['tshowcase_timg_height'];
endif;
		?>
		" size="3" /></td>
  ...
  <tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_mailto]" type="checkbox" id="tshowcase-settings[tshowcase_mailto]" value="1" 
	<?php
	if ( isset( $options['tshowcase_mailto'] ) ) {
...
<tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_tellink]" type="checkbox" id="tshowcase-settings[tshowcase_tellink]" value="1" 
	<?php
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_nofollow]" type="checkbox" id="tshowcase-settings[tshowcase_nofollow]" value="1" 
	<?php
   ...
   <tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_linkcssclass]" type="text" id="tshowcase-settings[tshowcase_linkcssclass]" value="
	<?php
	if ( isset( $options['tshowcase_linkcssclass'] ) ) {
		echo $options['tshowcase_linkcssclass']; }
	?>
	" ></td>
   ...
   <tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_linkrel]" type="text" id="tshowcase-settings[tshowcase_linkrel]" value="
	<?php
	if ( isset( $options['tshowcase_linkrel'] ) ) {
		echo $options['tshowcase_linkrel']; }
	?>
	" ></td>
   ...
   <tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_redirectuser]" type="checkbox" id="tshowcase-settings[tshowcase_redirectuser]" value="1" 
	<?php
  ...
  <tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_ajax_pagination]" type="checkbox" id="tshowcase-settings[tshowcase_ajax_pagination]" value="1" 
	<?php
  ...
  <tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_exclude_from_search]" type="checkbox" id="tshowcase-settings[tshowcase_exclude_from_search]" value="1" 
	<?php
	if ( isset( $options['tshowcase_exclude_from_search'] ) ) {
		echo 'checked="checked"';}
	?>
	></td>
	<td><span class="howto">
	<?php
	echo __(
		'If active it will exclude the Team Showcase entries from the General Search Results (General Search Form). <br /> You can place a Search Form specific for Team Showcase entries using the widget option available or placing the following shortcode in your page:<br />
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_autocomplete]" type="checkbox" id="tshowcase-settings[tshowcase_autocomplete]" value="1" 
	<?php
	if ( isset( $options['tshowcase_autocomplete'] ) ) {
		echo 'checked="checked"';}
	?>
	></td>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_autocomplete_click]" type="checkbox" id="tshowcase-settings[tshowcase_autocomplete_click]" value="1" 
	<?php
	if ( isset( $options['tshowcase_autocomplete_click'] ) ) {
		echo 'checked="checked"';}
	?>
	></td>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_search_meta]" type="checkbox" id="tshowcase-settings[tshowcase_search_meta]" value="1" 
	<?php
	if ( isset( $options['tshowcase_search_meta'] ) ) {
		echo 'checked="checked"';}
	?>
	></td>
  ...
  <tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_one_entry_per_user]" type="checkbox" id="tshowcase-settings[tshowcase_one_entry_per_user]" value="1" 
	<?php
	if ( isset( $options['tshowcase_one_entry_per_user'] ) ) {
		echo 'checked="checked"';}
	?>
	></td>
  ...
  <tr>
   ...
   <tr>
		...
		<td nowrap>
		  <input name="tshowcase-settings[tshowcase_structural_data]" type="checkbox" id="tshowcase-settings[tshowcase_structural_data]" value="1" 
		  <?php
			if ( isset( $options['tshowcase_structural_data'] ) ) {
				echo 'checked="checked"';}
			?>
			>
		  </td>
  ...
  <tr>
	...
	<td nowrap><input name="tshowcase-settings[tshowcase_single_show_posts]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_posts]" value="1"  
	<?php
	if ( isset( $options['tshowcase_single_show_posts'] ) ) {
		echo 'checked="checked"';}
	?>
	>
	  <input type="text" name="tshowcase-settings[tshowcase_latest_title]" id="tshowcase-settings[tshowcase_latest_title]" value="
	  <?php
		if ( isset( $options['tshowcase_latest_title'] ) ) {
			echo $options['tshowcase_latest_title'];}
		?>
		"></td>
  ...
  <tr>
	...
	<td nowrap><table border="0" cellspacing="5" cellpadding="5">
	  <tr>
		<td nowrap><input name="tshowcase-settings[tshowcase_single_show_title]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_title]" value="1" 
		<?php
		if ( isset( $options['tshowcase_single_show_title'] ) ) {
			echo 'checked="checked"';}
		?>
		>
		  </td>
	  ...
	  <tr>
		<td nowrap><input name="tshowcase-settings[tshowcase_single_show_social]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_social]" value="1" 
		<?php
	  ...
	  <tr>
		<td nowrap><input name="tshowcase-settings[tshowcase_single_show_smallicons]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_smallicons]" value="1" 
		<?php
		if ( isset( $options['tshowcase_single_show_smallicons'] ) ) {
			echo 'checked="checked"';}
		?>
		>
		 </td>
	  ...
	  <tr>
		<td nowrap><input name="tshowcase-settings[tshowcase_single_show_photo]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_photo]" value="1" 
		<?php
	  ...
	  <tr>
		<td nowrap><input name="tshowcase-settings[tshowcase_single_show_groups]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_groups]" value="1" 
		<?php
		if ( isset( $options['tshowcase_single_show_groups'] ) ) {
			echo 'checked="checked"';}
		?>
		></td>
 ...
 <tr>
		<td nowrap><input name="tshowcase-settings[tshowcase_single_show_taxonomy]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_taxonomy]" value="1" 
			<?php
			if ( isset( $options['tshowcase_single_show_taxonomy'] ) ) {
				echo 'checked="checked"';}
			?>
		></td>
		<td nowrap>
			<?php
			if ( isset( $options['tshowcase_name_tax2'] ) ) {
				echo $options['tshowcase_name_tax2']; }
			?>
		</td>
		</tr>
 ...
 <tr>
		<td nowrap><input name="tshowcase-settings[tshowcase_single_show_ctaxonomy]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_ctaxonomy]" value="1" 
			<?php
			if ( isset( $options['tshowcase_single_show_ctaxonomy'] ) ) {
				echo 'checked="checked"';}
			?>
		></td>
		<td nowrap>
			<?php
			if ( isset( $options['tshowcase_name_tax3'] ) ) {
				echo $options['tshowcase_name_tax3']; }
			?>
		</td>
		</tr>
 ...
 <tr>
		<td nowrap><input name="tshowcase-settings[tshowcase_single_show_dtaxonomy]" type="checkbox" id="tshowcase-settings[tshowcase_single_show_dtaxonomy]" value="1" 
			<?php
			if ( isset( $options['tshowcase_single_show_dtaxonomy'] ) ) {
				echo 'checked="checked"';}
			?>
		></td>
		<td nowrap>
			<?php
			if ( isset( $options['tshowcase_name_tax4'] ) ) {
				echo $options['tshowcase_name_tax4']; }
			?>
		</td>
		</tr>
  ...
  <tr>
	...
	<td nowrap><input type="text" name="tshowcase-settings[tshowcase_archive_url]" value="
	<?php
	if ( isset( $options['tshowcase_archive_url'] ) ) {
		echo $options['tshowcase_archive_url']; }
	?>
	" /></td>
...
<tr>
  ...
  <tr>
		<td>&nbsp; </td>
		<td nowrap>
		  <input name="tshowcase-settings[tshowcase_second_tax]" type="checkbox" id="tshowcase-settings[tshowcase_second_tax]" value="1" 
		  <?php
			if ( isset( $options['tshowcase_second_tax'] ) ) {
				echo 'checked="checked"';}
			?>
   ...
   <tr>
	...
	<td nowrap><input type="text" name="tshowcase-settings[tshowcase_name_tax2]" value="
	<?php
	if ( isset( $options['tshowcase_name_tax2'] ) ) {
		echo $options['tshowcase_name_tax2'];
	};
...
<tr>
		<td>&nbsp; </td>
		<td nowrap>
		  <input name="tshowcase-settings[tshowcase_third_tax]" type="checkbox" id="tshowcase-settings[tshowcase_third_tax]" value="1" 
		  <?php
			if ( isset( $options['tshowcase_third_tax'] ) ) {
				echo 'checked="checked"';}
			?>
   ...
   <tr>
	...
	<td nowrap><input type="text" name="tshowcase-settings[tshowcase_name_tax3]" value="
	<?php
	if ( isset( $options['tshowcase_name_tax3'] ) ) {
		echo $options['tshowcase_name_tax3'];
	};
...
<tr>
		<td>&nbsp; </td>
		<td nowrap>
		  <input name="tshowcase-settings[tshowcase_fourth_tax]" type="checkbox" id="tshowcase-settings[tshowcase_fourth_tax]" value="1" 
		  <?php
			if ( isset( $options['tshowcase_fourth_tax'] ) ) {
				echo 'checked="checked"';}
			?>
   ...
   <tr>
	...
	<td nowrap><input type="text" name="tshowcase-settings[tshowcase_name_tax4]" value="
	<?php
	if ( isset( $options['tshowcase_name_tax4'] ) ) {
		echo $options['tshowcase_name_tax4'];
	};
  ...
  <tr>
	...
	<td nowrap><textarea style="width:100%; height:100px;" name="tshowcase-settings[tshowcase_custom_css]">
	<?php
	if ( isset( $options['tshowcase_custom_css'] ) ) {
		echo $options['tshowcase_custom_css']; }
	?>
	</textarea></td>
  ...
  <tr>
	...
	<td nowrap><textarea style="width:100%; height:100px;" name="tshowcase-settings[tshowcase_custom_js]">
	<?php
	if ( isset( $options['tshowcase_custom_js'] ) ) {
		echo $options['tshowcase_custom_js']; }
	?>
	</textarea></td>
	<td><span class="howto"><?php echo __( 'Place here any custom javascript you want to display together with the Team Showcase layout. <br> Javascript code can be dangerous. You are responsible for the code you include here. Avoid copying code from unreliable sources.', 'tshowcase' ); ?></span></td>
  </tr>
  <!--
  <tr>
...
<tr>
	...
	<td nowrap><input type="text" name="tshowcase-settings[tshowcase_envato_token]" value="
	<?php
	if ( isset( $options['tshowcase_envato_token'] ) ) {
		echo $options['tshowcase_envato_token'];
	};
	?>
	" /></td>
